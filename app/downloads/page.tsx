...
export default function DownloadsPage() {
  ...
  useEffect(() => {
    ...
    const downloadFile = () => {
      ...
      link.download = 'financial-planning-starter-guide.pdf'
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            Your FinanceWise Guide is Downloading
          </h1>
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            The download should start automatically. If it doesn't, click the button below to download your free FinanceWise financial planning guide.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 mb-8">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
              FinanceWise Complete Financial Planning Guide
            </h2>
            
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              Everything you need to know to start your financial journey. From budgeting to investing, this guide covers all the essentials.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              ...
              <div className="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">12K+</div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center justify-center">
                ...
                <span className="text-gray-700 dark:text-gray-300">Step-by-step financial planning process</span>
              </div>
              <div className="flex items-center justify-center">
                <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
                <span className="text-gray-700 dark:text-gray-300">Budget templates and worksheets</span>
              </div>
              <div className="flex items-center justify-center">
                <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
                <span className="text-gray-700 dark:text-gray-300">Investment strategies for beginners</span>
              </div>
            </div>
