...
export default function MortgageCalculator() {
  ...
  const calculateMortgage = () => {
    ...
    const downPaymentAmount = parseFloat(downPayment || '0') || 0
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Calculate your monthly mortgage payments, total interest, and see how much you&apos;ll pay over the life of your loan.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Enter your loan information to calculate your mortgage payments
              </CardDescription>
            </CardHeader>
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-300">Home Price:</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                    ...
                    <li>• Shop around for the best rate</li>
                  </ul>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Budget Planning</h4>
                  <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                    <li>• Keep payments under 28% of income</li>
                    <li>• Factor in property taxes and insurance</li>
                    <li>• Save for maintenance and repairs</li>
